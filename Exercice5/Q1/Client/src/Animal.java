...
public class Animal extends UnicastRemoteObject implements IAnimal{
    ...
    public Animal(String nomA, String nomM, IEspece espece, IDossier dossier, long id) throws RemoteException{
        this.nomAnimal = nomA;
        this.nomMaitre = nomM;
        this.espece = espece;
        this.dossierSuivi = dossier;
        this.idClientAdder = id;
    }
    ...
    public long getAddByClientId() throws RemoteException{
        return this.idClientAdder;
    }
